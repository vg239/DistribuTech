...
def create_users(roles, departments):
    ...
    # Create public API endpoints for roles and departments
    # This will allow the frontend to access them without authentication
...
def create_items():
    ...
    items_data = [
        ...
        {
            'name': 'Notebooks - Lined',
            'description': 'Lined notebooks, pack of 3',
